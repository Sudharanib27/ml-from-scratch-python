...
# ## Input to Logistic Regression Model: petal length/width
# 
# This script performs the following functions:
# 1. Load the Iris dataset from sklearn
# 2. Prepare the input data with petal length and petal width
...
# Providing petal Length and petal width as input
print(iris_dataset.feature_names)

X_train_final = X_train_scaled[:, [2, 3]]
X_test_final = X_test_scaled[:, [2, 3]]
...
plt.title('Decision Regions - Logistic Regression fpr Iris Dataset')
plt.show()
